    ...
    <section className="px-6 pt-10">
      <Container>
        <div className="text-center mb-12">
          <h2 className="text-[56px] font-bold text-[#0085FF]">
            Simple, Transparent Pricing
          </h2>
          <p className="mt-3 text-[20px] font-medium text-[#404040]">
          ...
          <div className="mt-6 flex items-center justify-center gap-3 text-sm">
            <span
              className={
                !isYearly
                  ? "font-semibold text-[#101010] text-[26px] leading-[36px]"
                  : ""
              }
            >
              Monthly
        ...
        <div className=" grid grid-cols-1 lg:grid-cols-3 gap-[45px]">
          <div className="rounded-2xl border border-gray-200 bg-[rgba(230,243,255,0.20)] p-8 shadow-sm group group-hover:border group-hover:border-[#0085FF]">
            <h3 className="text-[32px] leading-[48px] font-semibold text-black">
              Starter
            </h3>
