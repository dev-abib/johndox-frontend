            ...
            return (
              ...
              >
                <div className="flex items-center justify-center ">
                  <div className="flex w-[72px] h-[72px] flex-col items-center justify-center gap-[10px] shrink-0 rounded-[65px] bg-[#0085FF] text-[24px] font-medium leading-[36px] text-white mb-3">{Icon}</div>
                </div>
